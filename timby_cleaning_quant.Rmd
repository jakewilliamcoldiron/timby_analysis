...
timby_redcap_survey_responses_tcs = read_xlsx("./timby_analysis_data/timby_analysis_data_redcap_survey_responses.xlsx") |> 
  ...
  tcs_1_label = factor(tcs_1, 
                              levels = c(0, 1, 2, 3, 4, NA_real_),
                              labels = c("Never",
                                         "Seldom",
                                         "Sometimes",
                                         "Often",
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label)
...
timby_redcap_survey_responses_tcs_sdq = timby_redcap_survey_responses_tcs |> 
  ...
  sdq_ps_1_label = factor(sdq_ps_1, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
                                         "Prefer not to answer"), 
  ...
  sdq_hs_2_label = factor(sdq_hs_2, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ess_3_label = factor(sdq_ess_3, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ps_4_label = factor(sdq_ps_4, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  separate(sdq_5_i_get_very_angry_and_often_lose_my_temper_choose_one, into = c("sdq_cps_5"), extra = "drop") |>  
  mutate(sdq_cps_5 = recode(sdq_cps_5, 
                        "Not" = as.numeric(0),
                        "Somewhat" = as.numeric(1), 
                        "Certainly" = as.numeric(2),
                        "Prefer" = NA_real_
                        ), 
  sdq_cps_5_label = factor(sdq_cps_5, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_pps_6_label = factor(sdq_pps_6, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  separate(sdq_7_i_usually_do_as_i_am_told_choose_one, into = c("sdq_cps_7"), extra = "drop") |> 
  #inverted scoring, see sdq documentation
  mutate(sdq_cps_7 = recode(sdq_cps_7, 
                        "Not" = as.numeric(2),
                        "Somewhat" = as.numeric(1), 
                        "Certainly" = as.numeric(0),
                        "Prefer" = NA_real_
                        ), 
  sdq_cps_7_label = factor(sdq_cps_7, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ess_8_label = factor(sdq_ess_8, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ps_9_label = factor(sdq_ps_9, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_hs_10_label = factor(sdq_hs_10, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_pps_11_label = factor(sdq_pps_11, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  separate(sdq_12_i_fight_a_lot_i_can_make_other_people_do_what_i_want_choose_one, into = c("sdq_cps_12"), extra = "drop") |> 
  mutate(sdq_cps_12 = recode(sdq_cps_12, 
                        "Not" = as.numeric(0),
                        "Somewhat" = as.numeric(1), 
                        "Certainly" = as.numeric(2),
                        "Prefer" = NA_real_
                        ), 
  sdq_cps_12_label = factor(sdq_cps_12, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ess_13_label = factor(sdq_ess_13, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_pps_14_label = factor(sdq_pps_14, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_hs_15_label = factor(sdq_hs_15, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ess_16_label = factor(sdq_ess_16, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ps_17_label = factor(sdq_ps_17, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  separate(sdq_18_i_am_often_accused_of_lying_or_cheating_choose_one, into = c("sdq_cps_18"), extra = "drop") |>  
  mutate(sdq_cps_18 = recode(sdq_cps_18, 
                        "Not" = as.numeric(0),
                        "Somewhat" = as.numeric(1), 
                        "Certainly" = as.numeric(2),
                        "Prefer" = NA_real_
                        ), 
  sdq_cps_18_label = factor(sdq_cps_18, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_pps_19_label = factor(sdq_pps_19, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ps_20_label = factor(sdq_ps_20, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_hs_21_label = factor(sdq_hs_21, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  separate(sdq_22_i_take_things_that_are_not_mine_from_home_school_or_elsewhere_choose_one, into = c("sdq_cps_22"), extra = "drop") |> 
  #inverted scoring, see sdq documentation
  mutate(sdq_cps_22 = recode(sdq_cps_22, 
                        "Not" = as.numeric(0),
                        "Somewhat" = as.numeric(1), 
                        "Certainly" = as.numeric(2),
                        "Prefer" = NA_real_
                        ), 
  sdq_cps_22_label = factor(sdq_cps_22, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_pps_23_label = factor(sdq_pps_23, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_ess_24_label = factor(sdq_ess_24, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_hs_25_label = factor(sdq_hs_25, 
                              levels = c(0, 1, 2, NA_real_),
                              labels = c("Not True",
                                         "Somewhat True",
                                         "Certainly True",
  ...
  sdq_26_label = factor(sdq_26, 
                              levels = c(0, 1, 2, 3, NA_real_),
                              labels = c("No",
  ...
  mutate(sdq_27 = ifelse(is.na(sdq_27), "99", sdq_27)) |> 
  mutate(sdq_27 = recode(sdq_27, 
                        "Less than a month" = as.numeric(0),
                        "1-5 months" = as.numeric(1), 
                        "6-12 months" = as.numeric(2),
                        "Over a year" = as.numeric(3),
                        "99" = as.numeric(99),
                        "Prefer not to answer" = NA_real_,
                        ), 
         sdq_27_label = factor(sdq_27, 
                              levels = c(0, 1, 2, 3, 99, NA_real_),
                              labels = c("<1 Month",
                                         "1-5 Months",
                                         "6-12 Months",
                                         ">12 Months",
                                         "Did not answer sdq_26",
                                         "Prefer not to answer"),
                          exclude = NULL
                          )
  ) |>
  ...
  mutate(sdq_28 = ifelse(is.na(sdq_28), "99", sdq_28)) |>
  mutate(sdq_28 = recode(sdq_28,
         ...
         sdq_28_label = factor(sdq_28, 
                               levels = c(0, 1, 2, 99, NA_real_),
                               labels = c("Not at all / Only a little", 
                                          "Quite a lot", 
                                          "A great deal",
                                          "Did not answer sdq_26",
                                          "Prefer not to answer"),
  ...
  mutate(sdq_29 = recode(sdq_29, 
         ...
         sdq_29_label = factor(sdq_29, 
                               levels = c(0, 1, 2, 99, NA_real_),
                               labels = c("No / Yes - Minor Difficulties", 
                                          "Yes - Definite Difficulties", 
                                          "Yes - Severe Difficulties",
                                          "Did not answer sdq_26",
                                          "Prefer not to answer"),
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label)
...
timby_redcap_survey_responses_tcs_sdq_chs = timby_redcap_survey_responses_tcs_sdq |>
  ...
  mutate(chs_1 = recode(chs_1,
         ...
         chs_1_label = factor(chs_1, 
                               levels = c(0, 1, 2, 3, 4, 5, NA_real_),
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label, chs_1, chs_1_label, chs_2, chs_2_label, chs_3, chs_3_label, chs_4, chs_4_label, chs_5, chs_5_label, chs_6, chs_6_label)
...
timby_redcap_survey_responses_tcs_sdq_chs_crops = timby_redcap_survey_responses_tcs_sdq_chs |> 
  ...
  mutate(crops_10 = recode(crops_10, 
         ...
         crops_10_label = factor(crops_10, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_11 = recode(crops_11, 
         ...
         crops_11_label = factor(crops_11, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_12 = recode(crops_12, 
         ...
         crops_12_label = factor(crops_12, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_13 = recode(crops_13, 
         ...
         crops_13_label = factor(crops_13, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_14 = recode(crops_14, 
         ...
         crops_14_label = factor(crops_14, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_15 = recode(crops_15, 
         ...
         crops_15_label = factor(crops_15, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_16 = recode(crops_16, 
         ...
         crops_16_label = factor(crops_16, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_17 = recode(crops_17, 
         ...
         crops_17_label = factor(crops_17, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_18 = recode(crops_18, 
         ...
         crops_18_label = factor(crops_18, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_19 = recode(crops_19, 
         ...
         crops_19_label = factor(crops_19, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_20 = recode(crops_20, 
         ...
         crops_20_label = factor(crops_20, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_21 = recode(crops_21, 
         ...
         crops_21_label = factor(crops_21, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_22 = recode(crops_22, 
         ...
         crops_22_label = factor(crops_22, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_23 = recode(crops_23, 
         ...
         crops_23_label = factor(crops_23, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_24 = recode(crops_24, 
         ...
         crops_24_label = factor(crops_24, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_25 = recode(crops_25, 
         ...
         crops_25_label = factor(crops_25, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  mutate(crops_26 = recode(crops_26, 
         ...
         crops_26_label = factor(crops_26, 
                               levels = c(0, 1, 2, NA_real_),
                               labels = c("None", 
                                          "Some", 
                                          "Lots",
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label, chs_1, chs_1_label, chs_2, chs_2_label, chs_3, chs_3_label, chs_4, chs_4_label, chs_5, chs_5_label, chs_6, chs_6_label, crops_1, crops_1_label, crops_2, crops_2_label, crops_3, crops_3_label, crops_4, crops_4_label, crops_5, crops_5_label, crops_6, crops_6_label, crops_7, crops_7_label, crops_8, crops_8_label, crops_9, crops_9_label, crops_10, crops_10_label, crops_11, crops_11_label, crops_12, crops_12_label, crops_13, crops_13_label, crops_14, crops_14_label, crops_15, crops_15_label, crops_16, crops_16_label, crops_17, crops_17_label, crops_18, crops_18_label, crops_19, crops_19_label, crops_20, crops_20_label, crops_21, crops_21_label, crops_22, crops_22_label, crops_23, crops_23_label, crops_24, crops_24_label, crops_25, crops_25_label, 
crops_26, crops_26_label)
...
timby_redcap_survey_responses_tcs_sdq_chs_crops_pss = timby_redcap_survey_responses_tcs_sdq_chs_crops |> 
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label, chs_1, chs_1_label, chs_2, chs_2_label, chs_3, chs_3_label, chs_4, chs_4_label, chs_5, chs_5_label, chs_6, chs_6_label, crops_1, crops_1_label, crops_2, crops_2_label, crops_3, crops_3_label, crops_4, crops_4_label, crops_5, crops_5_label, crops_6, crops_6_label, crops_7, crops_7_label, crops_8, crops_8_label, crops_9, crops_9_label, crops_10, crops_10_label, crops_11, crops_11_label, crops_12, crops_12_label, crops_13, crops_13_label, crops_14, crops_14_label, crops_15, crops_15_label, crops_16, crops_16_label, crops_17, crops_17_label, crops_18, crops_18_label, crops_19, crops_19_label, crops_20, crops_20_label, crops_21, crops_21_label, crops_22, crops_22_label, crops_23, crops_23_label, crops_24, crops_24_label, crops_25, crops_25_label, crops_26, crops_26_label, pss_1, pss_1_label, pss_2, pss_2_label, pss_3, pss_3_label, pss_4, pss_4_label, pss_5, pss_5_label, pss_6, pss_6_label, pss_7, pss_7_label, pss_8, pss_8_label, pss_9, pss_9_label, pss_10, pss_10_label)
...
timby_redcap_survey_responses_tcs_sdq_chs_crops_pss_bc = timby_redcap_survey_responses_tcs_sdq_chs_crops_pss |> 
  ...
  mutate(bc_ac_1 = recode(bc_ac_1, 
         ...
         bc_ac_1_label = factor(bc_ac_1, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
  ...
  mutate(bc_pfc_2 = recode(bc_pfc_2, 
         ...
         bc_pfc_2_label = factor(bc_pfc_2, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_5 = recode(bc_efc_5, 
         ...
         bc_efc_5_label = factor(bc_efc_5, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_pfc_7 = recode(bc_pfc_7, 
         ...
         bc_pfc_7_label = factor(bc_pfc_7, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_9 = recode(bc_efc_9, 
         ...
         bc_efc_9_label = factor(bc_efc_9, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
...
, into = c("bc_pfc_10"), extra = "drop") |> 
  mutate(bc_pfc_10 = recode(bc_pfc_10, 
         ...
         bc_pfc_10_label = factor(bc_pfc_10, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_ac_11 = recode(bc_ac_11, 
         ...
         bc_ac_11_label = factor(bc_ac_11, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_pfc_12 = recode(bc_pfc_12, 
         ...
         bc_pfc_12_label = factor(bc_pfc_12, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_13 = recode(bc_efc_13, 
         ...
         bc_efc_13_label = factor(bc_efc_13, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_pfc_14 = recode(bc_pfc_14, 
         ...
         bc_pfc_14_label = factor(bc_pfc_14, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_15 = recode(bc_efc_15, 
         ...
         bc_efc_15_label = factor(bc_efc_15, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_ac_16 = recode(bc_ac_16, 
         ...
         bc_ac_16_label = factor(bc_ac_16, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_pfc_17 = recode(bc_pfc_17, 
         ...
         bc_pfc_17_label = factor(bc_pfc_17, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_18 = recode(bc_efc_18, 
         ...
         bc_efc_18_label = factor(bc_efc_18, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_ac_19 = recode(bc_ac_19, 
         ...
         bc_ac_19_label = factor(bc_ac_19, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_20 = recode(bc_efc_20, 
         ...
         bc_efc_20_label = factor(bc_efc_20, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_21 = recode(bc_efc_21, 
         ...
         bc_efc_21_label = factor(bc_efc_21, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_22 = recode(bc_efc_22, 
         ...
         bc_efc_22_label = factor(bc_efc_22, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_pfc_23 = recode(bc_pfc_23, 
         ...
         bc_pfc_23_label = factor(bc_pfc_23, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_24 = recode(bc_efc_24, 
         ...
         bc_efc_24_label = factor(bc_efc_24, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_pfc_25 = recode(bc_pfc_25, 
         ...
         bc_pfc_25_label = factor(bc_pfc_25, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_26 = recode(bc_efc_26, 
         ...
         bc_efc_26_label = factor(bc_efc_26, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_27 = recode(bc_efc_27, 
         ...
         bc_efc_27_label = factor(bc_efc_27, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  mutate(bc_efc_28 = recode(bc_efc_28, 
         ...
         bc_efc_28_label = factor(bc_efc_28, 
                               levels = c(0, 1, 2, 3, 4, NA_real_),
                               labels = c("I haven't been doing this at all", 
                                          "I've been doing this a little bit", 
                                          "I've been doing this a medium amount",
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label, chs_1, chs_1_label, chs_2, chs_2_label, chs_3, chs_3_label, chs_4, chs_4_label, chs_5, chs_5_label, chs_6, chs_6_label, crops_1, crops_1_label, crops_2, crops_2_label, crops_3, crops_3_label, crops_4, crops_4_label, crops_5, crops_5_label, crops_6, crops_6_label, crops_7, crops_7_label, crops_8, crops_8_label, crops_9, crops_9_label, crops_10, crops_10_label, crops_11, crops_11_label, crops_12, crops_12_label, crops_13, crops_13_label, crops_14, crops_14_label, crops_15, crops_15_label, crops_16, crops_16_label, crops_17, crops_17_label, crops_18, crops_18_label, crops_19, crops_19_label, crops_20, crops_20_label, crops_21, crops_21_label, crops_22, crops_22_label, crops_23, crops_23_label, crops_24, crops_24_label, crops_25, crops_25_label, crops_26, crops_26_label, pss_1, pss_1_label, pss_2, pss_2_label, pss_3, pss_3_label, pss_4, pss_4_label, pss_5, pss_5_label, pss_6, pss_6_label, pss_7, pss_7_label, pss_8, pss_8_label, pss_9, pss_9_label, pss_10, pss_10_label, bc_ac_1, bc_ac_1_label, bc_pfc_2, bc_pfc_2_label, bc_ac_3, bc_ac_3_label, bc_ac_4, bc_ac_4_label, bc_efc_5, bc_efc_5_label, bc_ac_6, bc_ac_6_label, bc_pfc_7, bc_pfc_7_label, bc_ac_8, bc_ac_8_label, bc_efc_9, bc_efc_9_label, bc_pfc_10, bc_pfc_10_label, bc_ac_11, bc_ac_11_label, bc_pfc_12, bc_pfc_12_label, bc_efc_13, bc_efc_13_label, bc_pfc_14, bc_pfc_14_label, bc_efc_15, bc_efc_15_label, bc_ac_16, bc_ac_16_label, bc_pfc_17, bc_pfc_17_label, bc_efc_18, bc_efc_18_label, bc_ac_19, bc_ac_19_label, bc_efc_20, bc_efc_20_label, bc_efc_21, bc_efc_21_label, bc_efc_22, bc_efc_22_label, bc_pfc_23, bc_pfc_23_label, bc_efc_24, bc_efc_24_label, bc_pfc_25, bc_pfc_25_label, bc_efc_26, bc_efc_26_label, bc_efc_27, bc_efc_27_label, bc_efc_28, bc_efc_28_label)
...
timby_redcap_survey_responses_tcs_sdq_chs_crops_pss_bc_camm = timby_redcap_survey_responses_tcs_sdq_chs_crops_pss_bc |> 
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label, chs_1, chs_1_label, chs_2, chs_2_label, chs_3, chs_3_label, chs_4, chs_4_label, chs_5, chs_5_label, chs_6, chs_6_label, crops_1, crops_1_label, crops_2, crops_2_label, crops_3, crops_3_label, crops_4, crops_4_label, crops_5, crops_5_label, crops_6, crops_6_label, crops_7, crops_7_label, crops_8, crops_8_label, crops_9, crops_9_label, crops_10, crops_10_label, crops_11, crops_11_label, crops_12, crops_12_label, crops_13, crops_13_label, crops_14, crops_14_label, crops_15, crops_15_label, crops_16, crops_16_label, crops_17, crops_17_label, crops_18, crops_18_label, crops_19, crops_19_label, crops_20, crops_20_label, crops_21, crops_21_label, crops_22, crops_22_label, crops_23, crops_23_label, crops_24, crops_24_label, crops_25, crops_25_label, crops_26, crops_26_label, pss_1, pss_1_label, pss_2, pss_2_label, pss_3, pss_3_label, pss_4, pss_4_label, pss_5, pss_5_label, pss_6, pss_6_label, pss_7, pss_7_label, pss_8, pss_8_label, pss_9, pss_9_label, pss_10, pss_10_label, bc_ac_1, bc_ac_1_label, bc_pfc_2, bc_pfc_2_label, bc_ac_3, bc_ac_3_label, bc_ac_4, bc_ac_4_label, bc_efc_5, bc_efc_5_label, bc_ac_6, bc_ac_6_label, bc_pfc_7, bc_pfc_7_label, bc_ac_8, bc_ac_8_label, bc_efc_9, bc_efc_9_label, bc_pfc_10, bc_pfc_10_label, bc_ac_11, bc_ac_11_label, bc_pfc_12, bc_pfc_12_label, bc_efc_13, bc_efc_13_label, bc_pfc_14, bc_pfc_14_label, bc_efc_15, bc_efc_15_label, bc_ac_16, bc_ac_16_label, bc_pfc_17, bc_pfc_17_label, bc_efc_18, bc_efc_18_label, bc_ac_19, bc_ac_19_label, bc_efc_20, bc_efc_20_label, bc_efc_21, bc_efc_21_label, bc_efc_22, bc_efc_22_label, bc_pfc_23, bc_pfc_23_label, bc_efc_24, bc_efc_24_label, bc_pfc_25, bc_pfc_25_label, bc_efc_26, bc_efc_26_label, bc_efc_27, bc_efc_27_label, bc_efc_28, bc_efc_28_label, camm_1, camm_1_label, camm_2, camm_2_label, camm_3, camm_3_label, camm_4, camm_4_label, camm_5, camm_5_label, camm_6, camm_6_label, camm_7, camm_7_label, camm_8, camm_8_label, camm_9, camm_9_label, camm_10, camm_10_label)
...
timby_redcap_survey_responses_tcs_sdq_chs_crops_pss_bc_camm_meta = timby_redcap_survey_responses_tcs_sdq_chs_crops_pss_bc_camm |> 
  ...
  mutate(meta_1 = recode(meta_1,
         ...
         meta_1_label = factor(meta_1, 
                               levels = c(1, 2, 3, 4, 5, NA_real_),
  ...
  relocate(study_id, survey_stage, tcs_1, tcs_1_label, tcs_2, tcs_2_label, tcs_3, tcs_3_label, tcs_4, tcs_4_label, sdq_ps_1, sdq_ps_1_label, sdq_hs_2, sdq_hs_2_label, sdq_ess_3, sdq_ess_3_label, sdq_ps_4, sdq_ps_4_label, sdq_cps_5, sdq_cps_5_label, sdq_pps_6, sdq_pps_6_label, sdq_cps_7, sdq_cps_7_label, sdq_ess_8, sdq_ess_8_label, sdq_ps_9, sdq_ps_9_label, sdq_hs_10, sdq_hs_10_label, sdq_pps_11, sdq_pps_11_label, sdq_cps_12, sdq_cps_12_label, sdq_ess_13, sdq_ess_13_label, sdq_pps_14, sdq_pps_14_label, sdq_hs_15, sdq_hs_15_label, sdq_ess_16, sdq_ess_16_label, sdq_ps_17, sdq_ps_17_label, sdq_cps_18, sdq_cps_18_label, sdq_pps_19, sdq_pps_19_label, sdq_ps_20, sdq_ps_20_label, sdq_hs_21, sdq_hs_21_label, sdq_cps_22, sdq_cps_22_label, sdq_pps_23, sdq_pps_23_label, sdq_ess_24, sdq_ess_24_label, sdq_hs_25, sdq_hs_25_label, sdq_26, sdq_26_label, sdq_27, sdq_27_label, sdq_28, sdq_28_label, sdq_29, sdq_29_label, sdq_30, sdq_30_label, sdq_31, sdq_31_label, sdq_32, sdq_32_label, sdq_33, sdq_33_label, chs_1, chs_1_label, chs_2, chs_2_label, chs_3, chs_3_label, chs_4, chs_4_label, chs_5, chs_5_label, chs_6, chs_6_label, crops_1, crops_1_label, crops_2, crops_2_label, crops_3, crops_3_label, crops_4, crops_4_label, crops_5, crops_5_label, crops_6, crops_6_label, crops_7, crops_7_label, crops_8, crops_8_label, crops_9, crops_9_label, crops_10, crops_10_label, crops_11, crops_11_label, crops_12, crops_12_label, crops_13, crops_13_label, crops_14, crops_14_label, crops_15, crops_15_label, crops_16, crops_16_label, crops_17, crops_17_label, crops_18, crops_18_label, crops_19, crops_19_label, crops_20, crops_20_label, crops_21, crops_21_label, crops_22, crops_22_label, crops_23, crops_23_label, crops_24, crops_24_label, crops_25, crops_25_label, crops_26, crops_26_label, pss_1, pss_1_label, pss_2, pss_2_label, pss_3, pss_3_label, pss_4, pss_4_label, pss_5, pss_5_label, pss_6, pss_6_label, pss_7, pss_7_label, pss_8, pss_8_label, pss_9, pss_9_label, pss_10, pss_10_label, bc_ac_1, bc_ac_1_label, bc_pfc_2, bc_pfc_2_label, bc_ac_3, bc_ac_3_label, bc_ac_4, bc_ac_4_label, bc_efc_5, bc_efc_5_label, bc_ac_6, bc_ac_6_label, bc_pfc_7, bc_pfc_7_label, bc_ac_8, bc_ac_8_label, bc_efc_9, bc_efc_9_label, bc_pfc_10, bc_pfc_10_label, bc_ac_11, bc_ac_11_label, bc_pfc_12, bc_pfc_12_label, bc_efc_13, bc_efc_13_label, bc_pfc_14, bc_pfc_14_label, bc_efc_15, bc_efc_15_label, bc_ac_16, bc_ac_16_label, bc_pfc_17, bc_pfc_17_label, bc_efc_18, bc_efc_18_label, bc_ac_19, bc_ac_19_label, bc_efc_20, bc_efc_20_label, bc_efc_21, bc_efc_21_label, bc_efc_22, bc_efc_22_label, bc_pfc_23, bc_pfc_23_label, bc_efc_24, bc_efc_24_label, bc_pfc_25, bc_pfc_25_label, bc_efc_26, bc_efc_26_label, bc_efc_27, bc_efc_27_label, bc_efc_28, bc_efc_28_label, camm_1, camm_1_label, camm_2, camm_2_label, camm_3, camm_3_label, camm_4, camm_4_label, camm_5, camm_5_label, camm_6, camm_6_label, camm_7, camm_7_label, camm_8, camm_8_label, camm_9, camm_9_label, camm_10, camm_10_label, meta_1, meta_1_label, meta_2, meta_2_label, meta_3, meta_3_label, meta_4, meta_4_label, meta_5, meta_5_label, meta_6, meta_6_label, meta_7, meta_7_label, complete)
...
timby_redcap_survey_responses_scores = timby_redcap_survey_responses_tcs_sdq_chs_crops_pss_bc_camm_meta |> 
  
  mutate(tcs_score = tcs_1 + tcs_2 + tcs_3 + tcs_4) |> 
  
  mutate(sdq_ess_score = rowSums(
    data.frame(sdq_ess_3, sdq_ess_8, sdq_ess_13, sdq_ess_16, sdq_ess_24),
    na.rm = TRUE
  ))

  # Calculate other scores
  mutate(sdq_cps_score = sdq_cps_5 + sdq_cps_7 + sdq_cps_12 + sdq_cps_18 + sdq_cps_22) %>%
  mutate(sdq_hs_score = sdq_hs_2 + sdq_hs_10 + sdq_hs_15 + sdq_hs_21 + sdq_hs_25) %>%
  mutate(sdq_pps_score = sdq_pps_6 + sdq_pps_11 + sdq_pps_14 + sdq_pps_19 + sdq_pps_23) %>%
  mutate(sdq_ps_score = sdq_ps_1 + sdq_ps_4 + sdq_ps_9 + sdq_ps_17 + sdq_ps_20) %>%
  
  # Calculate the total difficult score
  mutate(sdq_total_difficult_score = sdq_ess_score + sdq_cps_score + sdq_hs_score + sdq_pps_score) %>%
  
  # Select relevant columns
  select(study_id, tcs_score, sdq_ess_score, sdq_cps_score, sdq_hs_score, sdq_pps_score, sdq_ps_score, sdq_total_difficult_score)

print(timby_redcap_survey_responses_scores)
...
```{r importing and cleaning ehr, dsm dx}
#importing and cleaning ehr, dsm dx
...
```{r importing and cleaning ehr, mse}
#importing and cleaning ehr, mse
